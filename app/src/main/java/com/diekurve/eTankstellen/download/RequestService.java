...
//     */
//    private void runURLDownload(final String id, final String urlPath, final String filePath,
...
//         */
//        void runURLDownload(final String id, final String urlPath, final String filePath,
//                            final String fileName) {
...
//         */
//        DownloadThread(final String id, final String urlPath, final String filePath,
//                       final String fileName) {
...
//        public void run() {
//            try {
//                String myfolder = getApplicationContext().getExternalCacheDir().getPath()
//                        + "/" + filePath;
...
//                    boolean b = f.mkdir();
//                    if (!b)
//                        Log.i("(run) NZSE: ", "Verzeichnis " + filePath +
...
//
//                File output =
//                        new File(getApplicationContext().getExternalCacheDir().getPath()
//                        /*Environment.getExternalStorageDirectory().getPath()*/ + "/" +
//                                this.filePath + "/" + this.fileName);
//
//                if (output.exists() && !output.delete()) {
//                        Log.e("err", "File could not deleted");
//                }else {
//                    Toast.makeText(RequestService.this, "File deleted",
...
//                deliverResults(this.uniqueId, output.getAbsolutePath(), this.result,
//                        downloadedSize);
//            } catch (Exception e) {
