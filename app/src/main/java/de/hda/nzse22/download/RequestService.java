...
public class RequestService extends Service {
     ...
     */
    private void runURLDownload(final String id, final String urlPath, final String filePath, final String fileName) {
    ...
    public class RequestServiceBinder extends Binder {
         ...
         */
        void runURLDownload(final String id, final String urlPath, final String filePath, final String fileName) {
    ...
    class DownloadThread extends Thread {
        ...
        public void run() {
            try {
                String myfolder = getApplicationContext().getExternalCacheDir().getPath()/*Environment.getExternalStorageDirectory().getPath()*/ + "/" + filePath;
                ...
                File output = new File(getApplicationContext().getExternalCacheDir().getPath()
